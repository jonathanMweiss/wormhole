...
// HashedMessage is a message that is sent as an echo without the content to save bandwidth.
// this message should not be sent in Reliable Broadcast protocols, but in a Broadcast channel where one wants to
// learn that everyone saw the same message from the original sender.
type HashedMessage struct {
	...
	Origin *PartyId `protobuf:"bytes,3,opt,name=origin,proto3" json:"origin,omitempty"` // TODO: Consider if needed.
}

func (x *HashedMessage) Reset() {
	*x = HashedMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *HashedMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HashedMessage) ProtoMessage() {}

func (x *HashedMessage) ProtoReflect() protoreflect.Message {
	mi := &file_tsscomm_v1_tsscomm_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HashedMessage.ProtoReflect.Descriptor instead.
func (*HashedMessage) Descriptor() ([]byte, []int) {
	return file_tsscomm_v1_tsscomm_proto_rawDescGZIP(), []int{2}
}

func (x *HashedMessage) GetUuid() []byte {
	if x != nil {
		return x.Uuid
	}
	return nil
...
func (x *HashedMessage) GetDigest() []byte {
	if x != nil {
		return x.Digest
	}
	return nil
...
func (x *HashedMessage) GetOrigin() *PartyId {
	if x != nil {
		return x.Origin
	}
	return nil
...
func (x *SignedMessage) GetContent() *TssContent {
	if x != nil {
		return x.Content
	}
	return nil
...
type Echo struct {
	...
	// Types that are assignable to Echoed:
	//
	//	*Echo_Message
	//	*Echo_Hashed
	Echoed isEcho_Echoed `protobuf_oneof:"echoed"`
}
...
func (m *Echo) GetEchoed() isEcho_Echoed {
	if m != nil {
		return m.Echoed
	}
	return nil
...
func (x *Echo) GetMessage() *SignedMessage {
	if x, ok := x.GetEchoed().(*Echo_Message); ok {
		return x.Message
	}
	return nil
}

func (x *Echo) GetHashed() *HashedMessage {
	if x, ok := x.GetEchoed().(*Echo_Hashed); ok {
		return x.Hashed
	}
	return nil
}

type isEcho_Echoed interface {
	isEcho_Echoed()
}

type Echo_Message struct {
	Message *SignedMessage `protobuf:"bytes,1,opt,name=message,proto3,oneof"`
}

type Echo_Hashed struct {
	Hashed *HashedMessage `protobuf:"bytes,2,opt,name=hashed,proto3,oneof"`
}

func (*Echo_Message) isEcho_Echoed() {}

func (*Echo_Hashed) isEcho_Echoed() {}
...
var file_tsscomm_v1_tsscomm_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x2f, 0x74, 0x73, 0x73, 0x2f, 0x76, 0x31, 0x3b, 0x74, 0x73, 0x73, 0x63, 0x6f, 0x6d, 0x6d, 0x76,
...
var file_tsscomm_v1_tsscomm_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_tsscomm_v1_tsscomm_proto_goTypes = []interface{}{
	...
	(*HashedMessage)(nil),     // 2: tsscomm.v1.HashedMessage
	(*SignedMessage)(nil),     // 3: tsscomm.v1.SignedMessage
	(*Echo)(nil),              // 4: tsscomm.v1.Echo
	(*Unicast)(nil),           // 5: tsscomm.v1.Unicast
	(*PropagatedMessage)(nil), // 6: tsscomm.v1.PropagatedMessage
	(*emptypb.Empty)(nil),     // 7: google.protobuf.Empty
}
var file_tsscomm_v1_tsscomm_proto_depIdxs = []int32{
	0, // 0: tsscomm.v1.HashedMessage.origin:type_name -> tsscomm.v1.PartyId
	1, // 1: tsscomm.v1.SignedMessage.content:type_name -> tsscomm.v1.TssContent
	0, // 2: tsscomm.v1.SignedMessage.sender:type_name -> tsscomm.v1.PartyId
	3, // 3: tsscomm.v1.Echo.message:type_name -> tsscomm.v1.SignedMessage
	2, // 4: tsscomm.v1.Echo.hashed:type_name -> tsscomm.v1.HashedMessage
	...
	6, // 8: tsscomm.v1.DirectLink.Send:input_type -> tsscomm.v1.PropagatedMessage
	7, // 9: tsscomm.v1.DirectLink.Send:output_type -> google.protobuf.Empty
